...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <a id="navlink" class="nav-link" href="../workstation/">Agenda Planner</a>
                </li>
    ...
    <div class="row">
        ...
        <div id="maincontainer" class="ml-sm-auto" style="width: 100%;padding-right:0;">
            ...
            <div id="formcontainer" style="margin: 50px 100px;">
            <div style="width: 100%;">
    ...
    <script src="https://bindhumadhav.in/bossbuddy/js/html2pdf.bundle.min.js"></script>
    <script src="../js/bootstrap.bundle.min.js"></script>
    <script src="../js/bootstrap.min.js"></script>
    <script src="../js/main.js"></script>
    
    <script src="https://bindhumadhav.in/bossbuddy/resume_maker/resumeScripts.js"></script>
</body>
