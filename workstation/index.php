...
<body>
    <nav class="navbar navbar-expand-lg fixed-top navbar-light">
        <a class="navbar-brand" href="../">
            <span class="brand">SE <span>Project</span></span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active" id="active">
                    <a id="navlink" class="nav-link" href="#">Agenda Planner</a>
                </li>
                <li class="nav-item">
                    <a id="navlink" class="nav-link" href="../resume_maker/">Resume Maker</a>
                </li>
    ...
    <div class="row">
        ...
        <div id="maincontainer" class="ml-sm-auto" style="width: 100%;padding-right:0;">
            <div id="tooltip">
                <?php
            ...
            <div class="container-fluid row" style="margin: 0;">
                <div class="app row">
                    ...
                    <div class="calendar col-lg-7" style="padding:50px 150px;">
                    ...
                    <div class="events col-lg-5">
                        ...
                        <?php
                        if (!isset($_SESSION['logged'])) {
                            echo '<h2 style="margin-top:30%;">Please Login to add and view your plans.';
                        } else {
                            echo '<ul class="events-list" id="evelist">
                            </ul>
                            <h3>Add Event</h3>
                            <div id="addeventerror"></div>
                            <form onsubmit="return addevent();" id="addeveform">
                            <label for="time">Time : </label><br>
                            <input type="time"  id="time" name="time" value="22:00" class="form-control"/>
